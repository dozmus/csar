...
Third-party developers will be able to use this to extend csar, or embed csar into complicated build processes and other applications.
...
Refactoring increases developer productivity by attempting to automate common tasks, and this accounts for a significant portion of a developer's activity. \autocite{mens2004survey,murphy2012we}
...
They will just need to write a plugin for them, analogously to how the java plugin will be written.
This will include the creation of a language parser, post-processor, searcher, and refactorer.
