...
csar-cli's command-line usage format is as follows:
\begin{lstlisting}
...
This is because `CsarContext' has more configurable fields than exposed through the command-line interface, and also allows subclassing.
