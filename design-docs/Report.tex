...
\begin{itemize}
  ...
  \item AutoQuery (More on this in the AutoQuery subsection later).
\end{itemize}
...
Its test cases are taken from ANTLR's repository \autoref{CodeReferences} and span 36 input classes.
