...
* <a name="footnote8">8</a>: Reiss, Steven P. (2009). Semantics-based code search. _Proceedings of the 31st International Conference on software engineering_. 30 (2). 243-253. Available from: https://dl.acm.org/citation.cfm?id=1555040 [Accessed 4th December 2017].
* <a name="footnote9">9</a>: Dobos, Daniel & Elbaum, Sebastian & Stolee, Kathryn T. (2014). Solving the Search for Source Code. _ACM Transactions on Software Engineering and Methodology_. 23 (3). 1-45. Available from: https://dl.acm.org/citation.cfm?id=2581377 [Accessed 4th December 2017].
