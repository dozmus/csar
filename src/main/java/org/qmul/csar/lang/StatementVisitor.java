...
public abstract class StatementVisitor {
    ...
    public abstract void visitParameterVariableStatements(List<ParameterVariableStatement> statements);
    public abstract void visitAnnotations(List<Annotation> statement);
}
